...
public class SetListFragment extends Fragment implements
		SCFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.set_list_layout, container,
				false);
		final TrackListView listview = (TrackListView) rootView
				.findViewById(R.id.set_list_view);

		if (adapter == null) {
			adapter = new TrackListAdapter(R.id.set_list_view, inflater,
					R.layout.set_list_item_layout);
		}
		...
		Button downloadButton = (Button) rootView
				.findViewById(R.id.button_download_sets);
